...
module.exports = async function handler(req, res) {
  // CORS headers — update origin to your actual frontend domain
  ...
  // Build message history (cap at last 10 exchanges to manage token usage)
  ...
  try {
    ...
    return res.status(200).json({
      answer:      cleanText,
      advisorCTA,
      // Echo back so frontend can append to history
